...
| 元件 | 規格/性能要求 | 主要功能說明 |
| --- | --- | --- |
| 工業相機 | 1200萬畫素級工業相機 (x4) | 需為 1 吋光學格式、具備 GigE 網路介面之**全域快門 (Global Shutter)** 彩色感測器，以確保動態擷取影像不變形。 |
| 工業鏡頭 | 百萬畫素級廣角工業鏡頭 (x4) | 需為焦距 6mm 之 C-mount 鏡頭，**成像圈需支援 1.1 吋感測器**，解析力需匹配 1200 萬畫素等級相機，確保邊緣畫質清晰。 |
| 嵌入式電腦 | 搭載高效能處理器之嵌入式電腦 | 作為系統主要運算與影像處理單元，規格需能應對四路 1200 萬畫素之即時影像處理負載。 |
| 網路交換器 | 支援 PoE 供電之千兆 (Gigabit) 交換器 | 提供設備網路連接及相機電源供應 (PoE)。 |
| 鏡頭防護盒 | 工業級鏡頭防護盒 | 保護相機鏡頭免於現場環境的粉塵或噴濺影響。 |
